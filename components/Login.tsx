             ...
             <div className="relative z-10 flex flex-col items-center text-center max-w-md animate-in fade-in slide-in-from-top-10 duration-700">
                ...
                <div className="flex items-center gap-4 bg-white/10 px-5 py-2.5 rounded-full border border-white/10 backdrop-blur-sm">
                     ...
                     <div className="flex items-center gap-3 text-white/80">
                         <a href="https://web.facebook.com/muhammad.alimka/" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:scale-110 transition-transform"><Facebook size={18} /></a>
                         <a href="https://www.instagram.com/muh.alimka/" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:scale-110 transition-transform"><Instagram size={18} /></a>
                         <a href="https://www.tiktok.com/@muh.alimka" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:scale-110 transition-transform">
